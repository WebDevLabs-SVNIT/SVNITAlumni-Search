...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'alumni_search_alumni', 'posHeld', self.gf('django.db.models.fields.CharField')(max_length='100'))

        # Changing field 'Alumni.phOffice'
        db.alter_column(u'alumni_search_alumni', 'phOffice', self.gf('django.db.models.fields.CharField')(max_length='100'))

        # Changing field 'Alumni.street'
        db.alter_column(u'alumni_search_alumni', 'street', self.gf('django.db.models.fields.CharField')(max_length='250'))

        # Changing field 'Alumni.resLandmark'
        db.alter_column(u'alumni_search_alumni', 'resLandmark', self.gf('django.db.models.fields.CharField')(max_length='250'))

        # Changing field 'Alumni.phRes'
        db.alter_column(u'alumni_search_alumni', 'phRes', self.gf('django.db.models.fields.CharField')(max_length='100'))

        # Changing field 'Alumni.city'
        db.alter_column(u'alumni_search_alumni', 'city', self.gf('django.db.models.fields.CharField')(max_length='100'))

        # Changing field 'Alumni.phCell'
        db.alter_column(u'alumni_search_alumni', 'phCell', self.gf('django.db.models.fields.CharField')(max_length='100'))

        # Changing field 'Alumni.resAddress'
        db.alter_column(u'alumni_search_alumni', 'resAddress', self.gf('django.db.models.fields.CharField')(max_length='250'))

        # Changing field 'Alumni.address'
        db.alter_column(u'alumni_search_alumni', 'address', self.gf('django.db.models.fields.CharField')(max_length='250'))

        # Changing field 'Alumni.resCountry'
        db.alter_column(u'alumni_search_alumni', 'resCountry', self.gf('django.db.models.fields.CharField')(max_length='100'))

        # Changing field 'Alumni.country'
        db.alter_column(u'alumni_search_alumni', 'country', self.gf('django.db.models.fields.CharField')(max_length='100'))

        # Changing field 'Alumni.resCity'
        db.alter_column(u'alumni_search_alumni', 'resCity', self.gf('django.db.models.fields.CharField')(max_length='100'))

        # Changing field 'Alumni.landmark'
        db.alter_column(u'alumni_search_alumni', 'landmark', self.gf('django.db.models.fields.CharField')(max_length='250'))

        # Changing field 'Alumni.resState'
        db.alter_column(u'alumni_search_alumni', 'resState', self.gf('django.db.models.fields.CharField')(max_length='100'))
    ...
    models = {
        u'alumni_search.alumni': {
            ...
            'landmark': ('django.db.models.fields.CharField', [], {'max_length': "'250'"}),
            'phCell': ('django.db.models.fields.CharField', [], {'max_length': "'100'"}),
            'phOffice': ('django.db.models.fields.CharField', [], {'max_length': "'100'"}),
            'phRes': ('django.db.models.fields.CharField', [], {'max_length': "'100'"}),
            'pincode': ('django.db.models.fields.CharField', [], {'max_length': "'10'"}),
            'posHeld': ('django.db.models.fields.CharField', [], {'max_length': "'100'"}),
            'resAddress': ('django.db.models.fields.CharField', [], {'max_length': "'250'"}),
            'resCity': ('django.db.models.fields.CharField', [], {'max_length': "'100'"}),
            'resCountry': ('django.db.models.fields.CharField', [], {'max_length': "'100'"}),
            'resLandmark': ('django.db.models.fields.CharField', [], {'max_length': "'250'"}),
            'resPincode': ('django.db.models.fields.CharField', [], {'max_length': "'10'"}),
            'resState': ('django.db.models.fields.CharField', [], {'max_length': "'100'"}),
